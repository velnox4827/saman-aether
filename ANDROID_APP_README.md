...
Saman Tunnel v1.8.0 is the current stable Android release, with local SOCKS5/HTTP CONNECT proxy mode plus an optional Android VpnService/HEV device-VPN path and per-app routing.
